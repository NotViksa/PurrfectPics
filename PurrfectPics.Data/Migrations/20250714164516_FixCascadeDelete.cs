        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CatImages_AspNetUsers_UploadedById",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CatImagesId = table.Column<int>(type: "int", nullable: false),
                    TagsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CatImageTags", x => new { x.CatImagesId, x.TagsId });
                    table.ForeignKey(
                        name: "FK_CatImageTags_CatImages_CatImagesId",
                        column: x => x.CatImagesId,
                        principalTable: "CatImages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CatImageTags_Tags_TagsId",
                        column: x => x.TagsId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CatImageId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_CatImages_CatImageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Votes_CatImages_CatImageId",
                        column: x => x.CatImageId,
                        principalTable: "CatImages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CatImages_UploadedById",
                table: "CatImages",
                column: "UploadedById");

            migrationBuilder.CreateIndex(
                name: "IX_CatImageTags_TagsId",
                table: "CatImageTags",
                column: "TagsId");

            migrationBuilder.CreateIndex(
                name: "IX_Comments_CatImageId",
                table: "Comments",
                column: "CatImageId");
